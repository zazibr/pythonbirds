...
class FaseTestes(TestCase):
    ...
    def teste_acabou_com_porcos_e_passaros(self):
        fase = Fase()
        porcos = [PorcoFake(1, 1) for _ in range(2)]  # criando 2 porcos       - list comprehesion
        passaros = [PassaroFake(1, 1) for _ in range(2)]  # criando 2 pássaros - list comprehesion
